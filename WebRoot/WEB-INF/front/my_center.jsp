	...
	<div class="scroll-content" style="margin-top: 1px;">
		...
		<div class="m-user">
			<div class="userInfo" style="padding: 0.1rem">
				...
				<p class="num"  style="padding: 0.1rem 0.1rem;">帐号金额：${wallet.balance}&yen;&nbsp;&nbsp;&nbsp;<a href="./tranfer.html" style="font-size: 14px; color: orange;">领取红包</a></p>
				<p class="num"  style="padding: 0.1rem 0.1rem;">累计提层：${wallet.distrBalance}&yen;&nbsp;&nbsp;&nbsp;<a href="./distri-tip.html" style="font-size: 14px; color: orange;">分销说明</a></p>
			</div>
			<div class="userPic" style="margin-right: 0px;padding: 0.05rem">
				<p class="img">
					<a class="example-image-link" href="/center/distri-image.html" data-lightbox="example-1">
						我的二维码
						<img id="example2" class="example-image" width="90%" height="90%" src="/center/distri-image.html">
					</a>
				</p>
			</div>
		</div>
		...
		<div class="m-cells">
			<div class="m-cell-item">
				<a href="/center/order_list.html">订单列表</a>
			</div>
			<div class="m-cell-item">
			...
			<div class="m-cell-item">
				<a href="tel:<sp:config id="service.telphone"></sp:config>">客服电话(<sp:config id="service.telphone"></sp:config>)</a>
			</div>
			<div class="m-cell-item">
